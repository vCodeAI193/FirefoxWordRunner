const SETTINGS_VALIDATORS = {
  ...
  dimPage:         v => typeof v === 'boolean',
  bionicReading:   v => typeof v === 'boolean',
  overlayPosition: v => ['top-left', 'top-center', 'center', 'bottom-center', 'bottom-right'].includes(v),
  overlayBgColor:  v => typeof v === 'string' && /^#[0-9a-f]{6}$/i.test(v),
};
